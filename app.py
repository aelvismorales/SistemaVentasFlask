...
def crear_cuenta():
	...
	try:
		...
		db.session.rollback()
		raise Exception(f"Error en la creación de usuario: error {Error}")
...
def login():
	...
	if request.method=='POST' and user_form.validate():
		...
		try:
			...
			db.session.rollback()
			raise Exception(f"Error en el inicio de usuario: error {Error}")
...
def crear_producto():
	...
	try:
		...
		db.session.rollback()
		raise Exception(f"Error en la creación del producto: error {Error}")
...
def editar_id(id):
	...
	try:
		...
		db.session.rollback()
		raise Exception(f"Error en editar producto: error {Error}")
...
def eliminarproducto(id):
	...
	try:
		...
		db.session.rollback()
		raise Exception(f"Error en eliminar producto: error {Error}")
#-------------------------------------------------------------------------------------------------------#-------------------------------------------------------------------------------------------------------
		...
		if nombre_comprador and direccion_comprador and estado_nota and request.method == 'POST':
			...
			if existe_comprador is not None:
				...
				try:
					...
					db.session.rollback()
					raise Exception(f"Error en la creación de nota de pedido: error {Error}")
			else:
					datos_producto_json= json.dumps(session['producto'])
					...
					try:
						...
						db.session.rollback()
						raise Exception(f"Error en la creación de nota de pedido y registro de usuario: error {Error}")
	return redirect(url_for('.buscar_producto'))
...
def editarnota(id):
	...
	try:
		...
		db.session.rollback()
		raise Exception(f"Error en la edicion de la nota de pedido: error {Error}")
...
def anularnota(id):
	...
	try:
		...
		db.session.rollback()
		raise Exception(f"Error en anular nota de pedido: error {Error}")
...
def crearcomprador():
	...
	if request.method=='POST' and comprador.validate():
		...
		try:
			...
			db.session.rollback()
			raise Exception(f"Error en la creación de comprador: error {Error}")
...
def editarcomprador(id):
	...
	if request.method=='POST':
		try:
			...
			db.session.rollback()
			raise Exception(f"Error en editar los datos del comprador: error {Error}")
...
def eliminarcomprador(id):
	...
	try:
		...
		db.session.rollback()
		raise Exception(f"Error en eliminar a comprador: error {Error}")
